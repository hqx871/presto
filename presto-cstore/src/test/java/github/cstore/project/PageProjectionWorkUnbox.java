 ...
 */
public final class PageProjectionWorkUnbox
        implements Work<List<Block>>
{
    ...
    public PageProjectionWorkUnbox(List<BlockBuilder> blockBuilders, @Nullable SqlFunctionProperties properties, Page page, SelectedPositions selectedPositions)
    {
