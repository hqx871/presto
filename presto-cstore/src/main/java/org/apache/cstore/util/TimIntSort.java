...
public class TimIntSort
{
     ...
     */
    private TimIntSort(int[] a, IntComparator c, int[] work, int workBase, int workLen)
    {
        this.a = a;
        this.c = c;
    ...
    public static void sort(int[] a, int from, int len, IntComparator c)
    {
        sort(a, from, len, c, null, 0, 0);
    }
            ...
            int[] work, int workBase, int workLen)
    {
         ...
         */
        TimIntSort ts = new TimIntSort(a, c, work, workBase, workLen);
