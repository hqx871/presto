...
{
    CSTORE_METADATA_ERROR(0, EXTERNAL),
    CSTORE_DEEP_STORAGE_ERROR(1, EXTERNAL),
    CSTORE_SEGMENT_LOAD_ERROR(2, EXTERNAL),
    CSTORE_UNSUPPORTED_TYPE_ERROR(3, EXTERNAL),
    CSTORE_PUSHDOWN_UNSUPPORTED_EXPRESSION(4, EXTERNAL),
    CSTORE_QUERY_GENERATOR_FAILURE(5, EXTERNAL),
    CSTORE_BROKER_RESULT_ERROR(6, EXTERNAL),
