...
public final class ByteBufferBlock
        implements Block
{
    private static final int INSTANCE_SIZE = ClassLayout.parseClass(ByteBufferBlock.class).instanceSize();
    ...
    public ByteBufferBlock(ByteBuffer value, @Nullable Bitmap valueIsNull)
    {
        this(value, valueIsNull, value.capacity(), 0);
    }

    private ByteBufferBlock(ByteBuffer value, @Nullable Bitmap valueIsNull, int positionCount, int offsetBase)
    {
        this.value = value;
    ...
    public Block getRegion(int positionOffset, int length)
    {
        ...
        return new ByteBufferBlock(value, valueIsNull, length, offsetBase + positionOffset);
    }
