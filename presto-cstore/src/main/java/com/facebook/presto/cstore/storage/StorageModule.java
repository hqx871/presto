...
import com.facebook.presto.cstore.metadata.AssignmentLimiter;
import com.facebook.presto.cstore.metadata.DatabaseShardManager;
import com.facebook.presto.cstore.metadata.DatabaseShardRecorder;
import com.facebook.presto.cstore.metadata.MetadataConfig;
import com.facebook.presto.cstore.metadata.ShardCleaner;
import com.facebook.presto.cstore.metadata.ShardCleanerConfig;
        ...
        implements Module
{
    ...
    public void configure(Binder binder)
    {
        ...
        binder.bind(StorageManager.class).to(MemoryStorageManager.class).in(Scopes.SINGLETON);
