...
import com.facebook.presto.cstore.util.UuidUtil;
...
public interface ShardDao
{
    ...
    String SHARD_METADATA_COLUMNS = "table_id, shard_id, shard_uuid, is_delta, delta_uuid, mutable, bucket_number, row_count, compressed_size, uncompressed_size, xxhash64";
