...
import com.facebook.presto.cstore.CStoreMetadataFactory;
import com.facebook.presto.cstore.CStoreTableProperties;
        ...
        extends AbstractConfigurationAwareModule
{
    ...
    protected void setup(Binder binder)
    {
        ...
        binder.bind(CStoreMetadataFactory.class).in(Scopes.SINGLETON);
        binder.bind(CStoreTableProperties.class).in(Scopes.SINGLETON);
    }
