        ...
        implements ConnectorPageSourceProvider
{
            ...
            SplitContext splitContext)
    {
        ...
        TupleDomain<CStoreColumnHandle> predicate = raptorSplit.getEffectivePredicate();
    ...
    {
        List<CStoreColumnHandle> columnHandles = columns.stream().map(CStoreColumnHandle.class::cast).collect(toList());
        List<Long> columnIds = columnHandles.stream().map(CStoreColumnHandle::getColumnId).collect(toList());
        List<Type> columnTypes = columnHandles.stream().map(CStoreColumnHandle::getColumnType).collect(toList());
