        ...
        implements ConnectorPageSource
{
    ...
    public Page getNextPage()
    {
        try {
            ...
            DeltaShardLoader.RowsToKeepResult rowsToKeep = deltaShardLoader.getRowsToKeep(batchSize, filePosition);
    ...
    private static Block buildSequenceBlock(long start, int count, DeltaShardLoader.RowsToKeepResult rowsToKeep)
    {
            ...
            implements LazyBlockLoader<LazyBlock>
    {
        ...
        private final DeltaShardLoader.RowsToKeepResult rowsToKeep;
        private boolean loaded;

        public OrcBlockLoader(int columnIndex, DeltaShardLoader.RowsToKeepResult rowsToKeep)
        {
