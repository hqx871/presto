        ...
        extends TableElement
{
    ...
    public IndexDefinition(Optional<NodeLocation> location, Identifier name, Optional<String> type, List<Identifier> columns)
    {
        super(location);
    ...
    public boolean equals(Object obj)
    {
        ...
        IndexDefinition o = (IndexDefinition) obj;
