...
public interface GroupByHash
{
            ...
            UpdateMemory updateMemory)
    {
        ...
        //todo open hash or linked hash ?
        //return new MultiChannelGroupByOpenHash(hashTypes, hashChannels, inputHashChannel, expectedSize, processDictionary, joinCompiler, updateMemory);
        return new MultiChannelGroupByLinkedHash(hashTypes, hashChannels, inputHashChannel, expectedSize, processDictionary, joinCompiler, updateMemory);
    }
